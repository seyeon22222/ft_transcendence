...
export function info_html() {
    ...
    <div class="button-container">
        <div>
            <button class="btn custom-yellow-btn flex-grow-1 me-2 hover:bg-teal-700" id="match_button">매치 신청</button>
        </div>
        <div>
            <button class="btn custom-yellow-btn flex-grow-1 me-2 hover:bg-teal-700" id="chat_button">1:1 채팅</button>
        </div>
        <div>
            <button class="btn custom-yellow-btn flex-grow-1 me-2 hover:bg-teal-700" id="block_button">1:1 채팅 차단</button>
        </div>
        <div>
            <button class="btn custom-yellow-btn flex-grow-1 me-2 hover:bg-teal-700" id="block_release_button">1:1 채팅 차단 해제</button>
        </div>
    </div>
    `
}