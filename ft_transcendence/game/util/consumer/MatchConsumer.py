...
class MatchConsumer(AsyncWebsocketConsumer):
    ...
    async def game_update(self):
        while self.game_loop:
            ...
            self.paddle1.update(self.paddle1.dir[1] * 10 * self.delta_time, self.obstacle_repository[0].bot1[1], self.obstacle_repository[1].top1[1])
            self.paddle2.update(self.paddle2.dir[1] * 10 * self.delta_time, self.obstacle_repository[0].bot1[1], self.obstacle_repository[1].top1[1])
            self.ball.pos[2] = 1
